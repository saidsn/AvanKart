...
export const renderSettingsPage = async (req, res) => {
  try {
    ...
    return res.render("../../muessise/views/pages/settings", {
...
export const renderSessionsPage = async (req, res) => {
  try {
    ...
    return res.render("../../muessise/views/pages/activeSessions", {
      activeLang: req.getLocale(),
      csrfToken: req.csrfToken(),
      user,
      sessionCount
...
export const render2FAPage = async (req, res) => {
  try {
    ...
    return res.render("../../muessise/views/pages/2FASettings", {
      activeLang: req.getLocale(),
      csrfToken: req.csrfToken(),
      user,
    });
