$(document).ready(function () {
    const myData = [
        {
            kartLogo: "/public/images/Avankart/Imtiyazlar/Kartlar/ForkKnife.svg",
            background: "bg-[#FFBC0D]",
            kartType: "Yemək",
            activeUsers: "83",
            deactiveUsers: "23",
            rejected: "11",
        ...
        {
            kartLogo: "/public/images/Avankart/Imtiyazlar/Kartlar/Gift.svg",
            background: "bg-[#32B5AC]",
            kartType: "Hədiyyə",
            activeUsers: "45",
            deactiveUsers: "23",
            rejected: "11",
        ...
        {
            kartLogo: "/public/images/Avankart/Imtiyazlar/Kartlar/lucide_fuel.svg",
            background: "bg-[#64D2FF]",
            kartType: "Yanacaq",
            activeUsers: "320",
            deactiveUsers: "23",
            rejected: "11",
        ...
        {
            kartLogo: "/public/images/Avankart/Imtiyazlar/Kartlar/ShoppingBag.svg",
            background: "bg-[#34A853]",
            kartType: "Market",
            activeUsers: "90",
            deactiveUsers: "23",
            rejected: "11",
        ...
        {
            kartLogo: "/public/images/Avankart/Imtiyazlar/Kartlar/Briefcase.svg",
            background: "bg-[#00A3FF]",
            kartType: "Biznes",
            activeUsers: "75",
            deactiveUsers: "23",
            rejected: "11",
        ...
        {
            kartLogo: "/public/images/Avankart/Imtiyazlar/Kartlar/CurrencyEth.svg",
            background: "bg-[#B5D38F]",
            kartType: "Premium",
            activeUsers: "36",
            deactiveUsers: "23",
            rejected: "11",
        ...
        {
            kartLogo: "/public/images/Avankart/Imtiyazlar/Kartlar/uil_car-wash.svg",
            background: "bg-[#B8CDF2]",
            kartType: "Avto Yuma",
            activeUsers: "250",
            deactiveUsers: "23",
            rejected: "11",
                ...
                data: function(row) {
                    return `
                        <div class="flex items-center gap-2.5">
                            <div class="w-12 h-12 ${row.background} rounded-[500px] flex items-center justify-center">
                                <img src="${row.kartLogo}" alt="Image">
                            </div>
                ...
                data: function(row, type, set, meta) {
                    ...
                    switch (row.status) {
                        ...
                        <div class="flex items-center  my-1 py-[3.5px] pl-[12px] cursor-pointer h-[28px] hover:bg-item-hover
                                ...
                                <div onclick="clickAktiv()" class="flex items-center py-[3.5px] mt-1 mb-[4px] pl-[12px] cursor-pointer h-[28px] hover:bg-item-hover
                                    transition ease-out duration-300 active:bg-item-hover disabled:bg-none">
