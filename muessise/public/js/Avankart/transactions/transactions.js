          ...
          <div class="bg-sidebar-item dark:bg-side-bar-item-dark w-[450px] p-6 rounded-2xl shadow-lg border-3 border-stroke dark:border-[#FFFFFF1A] relative">
            ...
            <form class="flex flex-col gap-3">
                ...
                <label class="flex flex-col gap-[6px]">
                    ...
                    <select class="cursor-pointer hover:bg-container-2 w-full h-[36px] px-3 rounded-full border border-[#E5E7EB] bg-white text-xs font-normal text-[#1D222B] appearance-none">
