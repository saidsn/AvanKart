  ...
  overlay.innerHTML = `
    <div class="emaildogrulama-div w-[450px] dark:bg-table-hover-dark bg-body-bg border-[3px] border-[#0000001A] shadow-lg rounded-2xl p-6 fixed top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-50">
      <div class="flex items-center justify-between py-0.5 mb-5">
        ...
        <img onclick="toggleEmail()" src="/images/settings/Close.svg" alt="Close" class="cursor-pointer block dark:hidden">
        <img onclick="toggleEmail()" src="/images/settings/close-dark.svg" alt="Close" class="cursor-pointer hidden dark:block">
      </div>
      <div class="mt-5">
        <div>
  ...
  timeoutOverlay.innerHTML = `
    <div class="timeout-content w-[450px] dark:bg-table-hover-dark bg-body-bg border-[3px] border-[#0000001A] shadow-lg rounded-2xl p-6 fixed top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-50">
        <div class="flex items-center justify-end">
            <img src="/images/settings/Close.svg" alt="Close" class="cursor-pointer block dark:hidden" onclick="CloseAll()">
            <img src="/images/settings/close-dark.svg" alt="Close" class="cursor-pointer hidden dark:block" onclick="CloseAll()">
        </div>
...
function showSuccessModal() {
  ...
  overlay.innerHTML = `
    <div class="email-ugurlu w-[450px] h-[306px] dark:bg-table-hover-dark bg-body-bg border-[3px] border-[#0000001A] shadow-[0px_0px_30px_0px_rgba(0,0,0,0.05)] rounded-2xl p-6 fixed top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-50">
      <div class="flex items-center justify-end">
          <img src="/images/settings/Close.svg" alt="Close" class="cursor-pointer block dark:hidden" onclick="closeSuccessModal()">
          <img src="/images/settings/close-dark.svg" alt="Close" class="cursor-pointer hidden dark:block" onclick="closeSuccessModal()">
      </div>
      <div class="mt-5 flex items-center justify-center flex-col">
...
function toggleNumber() {
  ...
  overlay.innerHTML = `
    <div class="numberdogrulama-div w-[450px] dark:bg-table-hover-dark bg-body-bg border-[3px] border-[#0000001A] shadow-lg rounded-2xl p-6 fixed top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-50">
      <div class="flex items-center justify-between py-0.5 mb-5">
        <span class="text-[15px] font-medium dark:text-white">2 addımlı doğrulama</span>
        <img onclick="toggleNumber()" src="/images/settings/Close.svg" alt="Close" class="cursor-pointer block dark:hidden">
        <img onclick="toggleNumber()" src="/images/settings/close-dark.svg" alt="Close" class="cursor-pointer hidden dark:block">
      </div>
      <div class="mt-5">
        <div>
          <h1 class="text-[22px] font-semibold pb-1 dark:text-white">OTP</h1>
...
function showNumberTimeoutModal() {
  ...
  timeoutOverlay.innerHTML = `
    <div class="timeout-content w-[450px] dark:bg-table-hover-dark bg-body-bg border-[3px] border-[#0000001A] shadow-lg rounded-2xl p-6 fixed top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-50">
      <div class="flex items-center justify-end">
        <img src="/images/settings/Close.svg" alt="Close" class="cursor-pointer block dark:hidden" onclick="closeNumberAll()">
        <img src="/images/settings/close-dark.svg" alt="Close" class="cursor-pointer hidden dark:block" onclick="closeNumberAll()">
      </div>
      <div class="mt-5 flex items-center justify-center flex-col">
        <img src="/images/settings/Alarm clock.svg" alt="Alarm Clock" class="pb-6 block dark:hidden">
        <img src="/images/settings/Alarm clock.svg" alt="Alarm Clock" class="pb-6 hidden dark:block">
...
function showNumberSuccessModal() {
  ...
  overlay.innerHTML = `
      <div class="number-ugurlu w-[450px] h-[306px] dark:bg-table-hover-dark bg-body-bg border-[3px] border-[#0000001A] shadow-[0px_0px_30px_0px_rgba(0,0,0,0.05)] rounded-2xl p-6 fixed top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-50">
        <div class="flex items-center justify-end">
            <img src="/images/settings/Close.svg" alt="Close" class="cursor-pointer block dark:hidden" onclick="closeNumberSuccessModal()">
            <img src="/images/settings/close-dark.svg" alt="Close" class="cursor-pointer hidden dark:block" onclick="closeNumberSuccessModal()">
        </div>
        <div class="mt-5 flex items-center justify-center flex-col">
            <img src="/images/settings/Shield.svg" alt="Shield">
            <span class="text-[22px] font-semibold mt-[32px] dark:text-white">Uğurlu</span>
  ...
  overlay.innerHTML = `
    <div class="authdogrulama-div w-[450px] h-[544px] dark:bg-table-hover-dark bg-body-bg hidden border-[3px] border-[#0000001A] !shadow-[0px_0px_30px_0px_rgba(0,0,0,0.05)] rounded-[18px] p-6 fixed top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-50" style="display: block;">
      <div class="flex items-center justify-end py-0.5 mb-5">
          <img onclick="toggleAuthenticator()" src="/images/settings/Close.svg" alt="Close" class="cursor-pointer block dark:hidden">
          <img onclick="toggleAuthenticator()" src="/images/settings/close-dark.svg" alt="Close" class="cursor-pointer hidden dark:block">
        </div>
          ...
          <form action="#">
              <div class="w-full text-center space-y-4">
                  <div id="qrBox" class="my-6 dark:!bg-table-hover-dark bg-container-2 w-[180px] h-[180px] p-[15px] m-auto rounded-[8px] qr-animate">
                      ...
                      <img src="/images/settings/healthicons_qr-code.svg" alt="healthicons_qr-code" class="h-full w-full object-contain block dark:hidden">
                      <img src="/images/settings/healthicons_qr-code-dark.svg" alt="healthicons_qr-code" class="h-full w-full object-contain hidden dark:block">
                  </div>
...
function ireliAuthenticator() {
  ...
  tesdiqDiv.innerHTML = `
     <div class="flex items-center justify-end py-0.5 mb-5">
        <img onclick="closeTesdiqModal()" src="/images/settings/Close.svg" alt="Close" class="cursor-pointer block dark:hidden">
        <img onclick="closeTesdiqModal()" src="/images/settings/close-dark.svg" alt="Close" class="cursor-pointer hidden dark:block">
      </div>
