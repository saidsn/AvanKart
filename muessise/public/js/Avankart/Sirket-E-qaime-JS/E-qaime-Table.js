$(document).ready(function () {
  ...
  var table = $("#myTable").DataTable({
    ...
    columns: [
      {
        data: function (row) {
          return `<div onclick="invoysiller(id)" class="flex items-center gap-2.5">
      ...
      },
      {
        ...
        data: function (row, type, set, meta) {
          const idx = meta.row;
          return `
                        <div class="text-base flex items-center cursor-pointer dropdown-trigger">
