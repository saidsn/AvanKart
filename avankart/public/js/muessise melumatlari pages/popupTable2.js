$(document).ready(function () {
  const myData = [
    {
      ...
      gender: "Kişi",
      speciality: "Mühasib",
      email: "orkhanijrai@avankart.tech",
    ...
    },
    {
      ...
      gender: "Kişi",
      speciality: "Mühasib",
      email: "faridijrai@avankart.tech",
      phone: "+994 50 770 35 22",
    },
    {
      name: "İsa Sadiqli",
    ...
    },
    {
      name: "Jalə Ağayeva",
      gender: "Kişi",
      speciality: "Kiçik mühasib",
      email: "jaleagayeva@gmail.com",
      phone: "+994 50 770 35 22",
    },
    {
      name: "Orxan Ijari",
  ...
  const table = $("#myTablePop2").DataTable({
    ...
    columns: [
      ...
      {
        data: function (row) {
          return `<div class="icon stratis-trash-01 text-error cursor-pointer"></div>`;
        },
      },
    ],
