$(document).ready(function () {
  ...
  function updatePaginationInfoContracts() {
    ...
    // Previous button
    $pagination.append(`
      <div class="flex items-center justify-center px-3 h-8 ms-0 leading-tight cursor-pointer ${currentPageContracts === 0
    ...
    // Next button
    $pagination.append(`
      <div class="flex items-center justify-center px-3 h-8 ms-0 leading-tight cursor-pointer ${currentPageContracts === totalPagesContracts - 1
        ? "text-[#BFC8CC] dark:text-[#636B6F] cursor-not-allowed"
        : "text-messages dark:text-[#FFFFFF]"
      }"
