$(document).ready(function () {
  ...
  var table = $("#myTable3").DataTable({
        ...
        data: function (row) {
          return `<div class="relative flex items-center border border-surface-variant dark:border-surface-variant-dark rounded-full overflow-hidden 
            ...
            hover:bg-input-hover dark:hover:bg-input-hover-dark">
                        <input id="mealCard3" value="${row.cards.mealCard}" type="text"
      ...
      },
      {
        data: function (row) {
          return `<div class="relative flex items-center border border-surface-variant dark:border-surface-variant-dark rounded-full overflow-hidden 
            ...
            transition-all ease-out duration-300 
            hover:bg-input-hover dark:hover:bg-input-hover-dark">
                        <input id="fuelCard3" value="${row.cards.fuelCard}" type="text"
                            placeholder="Məbləği daxil edin" class="w-full h-full bg-transparent border-none focus:outline-none outline-none ring-0 focus:ring-0 
            text-[13px] text-messages dark:text-primary-text-color-dark 
            placeholder:text-on-surface-variant-dark dark:placeholder:text-[#636B6F]">
                        <div class="absolute right-3">
      ...
      },
      {
        data: function (row) {
          return `<div class="relative flex items-center border border-surface-variant dark:border-surface-variant-dark rounded-full overflow-hidden 
            ...
            transition-all ease-out duration-300 
            hover:bg-input-hover dark:hover:bg-input-hover-dark">
                        <input id="giftCard3" value="${row.cards.giftCard}" type="text"
                            placeholder="Məbləği daxil edin" class="w-full h-full bg-transparent border-none focus:outline-none outline-none ring-0 focus:ring-0 
            text-[13px] text-messages dark:text-primary-text-color-dark 
            placeholder:text-on-surface-variant-dark dark:placeholder:text-[#636B6F]">
                        <div class="absolute right-3">
      ...
      },
      {
        data: function (row) {
          return `<div class="relative flex items-center border border-surface-variant dark:border-surface-variant-dark rounded-full overflow-hidden 
            ...
            transition-all ease-out duration-300 
            hover:bg-input-hover dark:hover:bg-input-hover-dark">
                        <input id="marketCard3" value="${row.cards.marketCard}" type="text"
                            placeholder="Məbləği daxil edin" class="w-full h-full bg-transparent border-none focus:outline-none outline-none ring-0 focus:ring-0 
            text-[13px] text-messages dark:text-primary-text-color-dark 
            placeholder:text-on-surface-variant-dark dark:placeholder:text-[#636B6F]">
                        <div class="absolute right-3">
      ...
      },
      {
        data: function (row) {
          return `<div class="relative flex items-center border border-surface-variant dark:border-surface-variant-dark rounded-full overflow-hidden 
            ...
            transition-all ease-out duration-300 
            hover:bg-input-hover dark:hover:bg-input-hover-dark">
                        <input id="businessCard3" value="${row.cards.businessCard}" type="text"
                            placeholder="Məbləği daxil edin" class="w-full h-full bg-transparent border-none focus:outline-none outline-none ring-0 focus:ring-0 
            text-[13px] text-messages dark:text-primary-text-color-dark 
            placeholder:text-on-surface-variant-dark dark:placeholder:text-[#636B6F]">
                        <div class="absolute right-3">
      ...
      },
      {
        data: function (row) {
          return `<div class="relative flex items-center border border-surface-variant dark:border-surface-variant-dark rounded-full overflow-hidden 
            ...
            transition-all ease-out duration-300 
            hover:bg-input-hover dark:hover:bg-input-hover-dark">
                        <input id="premiumCard3" value="${row.cards.premiumCard}" type="text"
                            placeholder="Məbləği daxil edin" class="w-full h-full bg-transparent border-none focus:outline-none outline-none ring-0 focus:ring-0 
            text-[13px] text-messages dark:text-primary-text-color-dark 
            placeholder:text-on-surface-variant-dark dark:placeholder:text-[#636B6F]">
                        <div class="absolute right-3">
      ...
      },
      {
        data: function (row) {
          return `<div class="relative flex items-center border border-surface-variant dark:border-surface-variant-dark rounded-full overflow-hidden 
            ...
            transition-all ease-out duration-300 
            hover:bg-input-hover dark:hover:bg-input-hover-dark">
                        <input id="carWashCard3" value="${row.cards.carWashCard}" type="text"
                            placeholder="Məbləği daxil edin" class="w-full h-full bg-transparent border-none focus:outline-none outline-none ring-0 focus:ring-0 
            text-[13px] text-messages dark:text-primary-text-color-dark 
            placeholder:text-on-surface-variant-dark dark:placeholder:text-[#636B6F]">
                        <div class="absolute right-3">
        ...
        data: function (row, type, set, meta) {
          ...
          return `
            <div class="flex justify-center">
              <span id="eye3-${meta.row}" onclick="toggleRowVisibility3(${meta.row})"
    ...
    createdRow: function (row, data, dataIndex) {
      ...
      if (data.isHidden) {
        setTimeout(() => {
          const tableWidth = $("#myTable3").outerWidth();
          $(row).append(`
  ...
  window.toggleRowVisibility3 = function (rowIndex) {
