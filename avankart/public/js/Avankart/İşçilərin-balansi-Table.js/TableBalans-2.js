$(document).ready(function () {
    ...
    var table = $('#myTable').DataTable({
        ...
        columns: [
                {
                data: function(row) {
                    return `<span class="text-[13px] text-messages font-normal">${row.kateqoriya}</span>`;
                }
            },
            {
                data: function(row) {
                    return `<span class="text-[13px] text-messages font-normal flex items-center justify-left">${row.iscisayi}</span>`;
                }
            },
            {
                data: function(row) {
                    return `<span class="text-[13px] text-messages font-normal flex items-center justify-left">${row.amount} ₼</span>`;
                }
            },
            {
                data: function(row) {
