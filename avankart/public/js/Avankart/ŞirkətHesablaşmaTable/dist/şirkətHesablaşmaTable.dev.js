...
$(document).ready(function () {
  // Verilənlər
  var myData = [{
    logo: "/public/images/şirket-logo/pasha-holding.png",
    ...
    logo: "/public/images/şirket-logo/Veysəloglu.png",
    ...
    logo: "/public/images/şirket-logo/Kapital bank.png",
  ...
  var table = $("#myTable").DataTable({
    ...
    columns: [{
      ...
      data: function data(row) {
        return "<span class=\"text-[13px]  text-messages dark:text-primary-text-color-dark  flex justify-center font-normal\">".concat(row.amount, " \u20BC</span>");
      }
    }, {
      data: function data(row) {
    ...
    initComplete: function initComplete() {
      ...
      $("#myTable thead th.filtering").each(function () {
        $(this).html('<div class="custom-header flex w-[120px] gap-2.5 items-center"><div>' + $(this).text() + '</div><div class="icon stratis-sort-vertical-02 p-2 mt-1 text-messages"></div></div>');
      });
    },
