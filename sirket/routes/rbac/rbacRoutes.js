...
router.post("/update-imtiyaz-name", [verifyToken, csrfProtection], updateImtiyazName);
router.post("/delete-imtiyaz-group", [verifyToken, csrfProtection], deleteImtiyazGroup);
router.post("/sync-imtiyaz-member-counts", [verifyToken, csrfProtection], syncImtiyazMemberCounts);
router.post("/defaultPermUsers", [verifyToken, csrfProtection], getDefaultPermissionDetails);
