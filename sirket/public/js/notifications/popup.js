if (typeof window.notificationsOverlay === "undefined") {
  window.notificationsOverlay = document.getElementById("notificationsOverlay");
}

if (typeof window.notificationsModal === "undefined") {
  window.notificationsModal = document.getElementById("notificationsModal");
}

if (typeof window.allNotificationsModal === "undefined") {
  window.allNotificationsModal = document.getElementById("allNotificationsModal");
}

if (typeof window.personalNotificationsModal === "undefined") {
  window.personalNotificationsModal = document.getElementById("personalNotificationsModal");
}
