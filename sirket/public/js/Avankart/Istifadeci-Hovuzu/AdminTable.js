...
const table = $('#myTable').DataTable({
...

            {
                ...
                data: function(row, type, set, meta) {
                    ...
                    switch (row.status) {
                        ...
                        case "Deaktiv":
                            dropdownContent = `
                                <div class="relative w-[211px] h-[136px] border-[#0000001A] border-[0.5px]
                                    shadow-[0px_0px_12px_0px_rgba(0,0,0,0.1)] rounded-[8px] bg-white z-50">

                                    <div class="flex items-center  my-1 py-[3.5px] pl-[12px] cursor-pointer h-[28px] ">
                                        <div class="icon stratis-password-01 mt-[6px] w-[13px] h-[13px] mr-2 text-on-surface-variant-dark disabled:text-on-surface-variant-dark"></div>
                                        <span class="text-[13px] font-medium text-on-surface-variant-dark ">Şifrəni sıfırla</span>
                                    </div>

                                    <div class="flex items-center my-1 py-[3.5px] pl-[12px] cursor-pointer h-[28px] ">
                                        <div class="icon stratis-mail-01 mt-1 !w-[12px] !h-[9px] mr-2 text-on-surface-variant-dark "></div>
                                        <span class="text-[13px] font-medium text-on-surface-variant-dark ">Mail adresini dəyiş</span>
                                    </div>

                                    <div onclick="clickaktivet()" class="flex items-center my-1 py-[3.5px] pl-[12px] cursor-pointer h-[28px] hover:bg-item-hover
                                    transition ease-out duration-300 active:bg-item-hover disabled:bg-none">
                                    <div class="icon stratis-shield-check !w-[10px] !h-[13px] mr-2 text-messages disabled:text-on-surface-variant-dark"></div>
                                    <span class="text-[13px] font-medium text-messages disabled:text-on-surface-variant-dark">Aktiv et </span>
                                </div>
                                    <div class="h-[0.5px] bg-[#0000001A]"></div>

                                <div onclick="clickSilinmeMuraciet()" class="flex items-center py-[3.5px] mt-1 mb-[4px] pl-[12px] cursor-pointer h-[28px] transition
                                ease-out duration-300 hover:bg-[#DD38381A] active:bg-[#DD38381A] disabled:bg-body-bg">
                                <div class="icon stratis-trash-01  !w-[11px] !h-[12px] text-error mr-[9px] disabled:text-on-surface-variant-dark"></div>
                                <span class="text-[13px] text-error font-medium disabled:text-on-surface-variant-dark">Silinmə üçün müraciət et</span>
                            </div>
                        ...
                        case "Silinmə gözləyir":
                            dropdownContent = `
                                <div class="relative w-[211px] h-[106px] border-[#0000001A] border-[0.5px]
                                    shadow-[0px_0px_12px_0px_rgba(0,0,0,0.1)] rounded-[8px] bg-white z-0">

                                    <div onclick="clicksilinmeTesdiq()" class="flex items-center  my-1 py-[3.5px] pl-[12px] cursor-pointer h-[28px] hover:bg-item-hover
                                        transition ease-out duration-300 active:bg-item-hover disabled:bg-none">
                                        <div class="icon stratis-file-check-02 mt-[3px] !w-[12px] !h-[13px] mr-2 text-messages disabled:text-on-surface-variant-dark"></div>
                                        <span class="text-[13px] font-medium text-messages disabled:text-on-surface-variant-dark">Silinməni təsdiqlə</span>
                                    </div>

                                    <div onclick="clickhesabTesdiqi()" class="flex items-center my-1 py-[3.5px] pl-[12px] cursor-pointer h-[28px] hover:bg-item-hover
                                        transition ease-out duration-300 active:bg-item-hover disabled:bg-none">
                                        <div class="icon stratis-file-minus-02 mt-1 !w-[12px] !h-[13px] mr-2 text-messages disabled:text-on-surface-variant-dark"></div>
                                        <span class="text-[13px] font-medium text-messages disabled:text-on-surface-variant-dark">Rədd et</span>
                                    </div>

                                    <div class="h-[0.5px] bg-[#0000001A]"></div>

                                    <div class="flex items-center py-[3.5px] mt-1 mb-[4px] pl-[12px] cursor-pointer h-[28px] ">
                                        <div class="icon stratis-trash-01  w-[13px] h-[13px] text-on-surface-variant-dark mr-[9px] "></div>
                                        <span class="text-[13px] text-on-surface-variant-dark font-medium ">Silinmə üçün müraciət et</span>
                                    </div>
                                    </div>
                            `;
                            break;
        ...
        createdRow: function(row, data, dataIndex) {
            ...
            $('#myTable thead th:first-child label')
                .css({
                    'margin': '0 auto',
                    'display': 'flex',
