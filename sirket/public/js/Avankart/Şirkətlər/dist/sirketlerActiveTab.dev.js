...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var notificationButtons = document.querySelectorAll(".notification-type");
  notificationButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      ...
      notificationButtons.forEach(function (btn) {
        btn.classList.remove("active", "bg-inverse-on-surface", "text-messages", "cursor-default");
        btn.classList.add("text-tertiary-text", "cursor-pointer");
      });
      this.classList.add("active", "bg-inverse-on-surface", "text-messages", "cursor-default");
