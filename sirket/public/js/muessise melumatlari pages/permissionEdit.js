...
function populatePermissionCheckboxes(permissionData) {
  ...
  const permissions = [
    ...
    { key: "emeliyyatlar", id: "edit-emeliyyatlar-checkbox" },
    { key: "hesablasma", id: "edit-hesablasma-checkbox" },
    { key: "iscilerin_balansi", id: "edit-iscilerin-balansi-checkbox" },
    { key: "e_qaime", id: "edit-e-qaime-checkbox" },
    { key: "isciler", id: "edit-isciler-checkbox" },
    { key: "avankart_partner", id: "edit-avankart-checkbox" },
    { key: "sirket_melumatlari", id: "edit-sirket-melumatlari-checkbox" },
    { key: "profil", id: "edit-profil-checkbox" },
    { key: "istifadeciler", id: "edit-istifadeciler-checkbox" },
    { key: "salahiyyet_qruplari", id: "edit-salahiyyet-qruplari-checkbox" },
    { key: "rekvizitler", id: "edit-rekvizitler-checkbox" },
    { key: "muqavileler", id: "edit-muqavileler-checkbox" },
  ];
  ...
  const companyInfoCheckbox = $("#edit-sirket-melumatlari-checkbox");
...
$(document).ready(function () {
  ...
  // Yalnız "Şirkət məlumatları" dropdown üçün subsections açılıb-bağlanma
  $(document).on("click", ".permission-level-selector2 .permission-level-btn", function (e) {
    e.preventDefault();
    e.stopPropagation();

    const chevronImg = $(this).find('img');

    console.log("Şirkət məlumatları chevron düyməsinə klikləndi");

    const subsections = $("#company-info-subsections");
    const parentContainer = subsections.closest('.mx-3');

    if (parentContainer.length) {
      parentContainer.css('overflow', 'visible');
    }

    if (subsections.hasClass("h-0")) {
      chevronImg.addClass("rotate-180");

      subsections.removeClass("h-0").css({
        'height': '0px',
        'overflow': 'hidden',
      ...
      setTimeout(() => {
        const targetHeight = subsections.get(0).scrollHeight;
        subsections.css({
      ...
      chevronImg.removeClass("rotate-180");

      const currentHeight = subsections.outerHeight();
      subsections.css({
