$(document).ready(function () {
  ...
  // Global function to reload the table from other scripts
  window.reloadSorgularTable = function () {
    console.log('Reloading sorgular table via global function...');
    if (table && table.ajax) {
      table.ajax.reload(function (json) {
        console.log('Table reloaded via global function');
        console.log('Record count:', json.recordsFiltered);
        $('#sorgularCount').text(json.recordsFiltered);
      }, false);
    } else {
      console.log('Table instance not available, falling back to page reload');
